...
|Given below are contributions I made for the project. They showcase my capability to +
 ...
 2) write high quality functional and test codes that are error-free, comprehensible, and reusable. +
|===
...
|===
|The following sections are portions of my contributions to the User Guide. They reflect my ability to write clear and
concise documentation targeting non-technical readers. Since this is not the full version, some of the hyperlinks as
seen under this section may not redirect as intended. Please refer to section 5.6 and 5.7.5 - 5.7.8 of the
https://cs2103-ay1819s1-f10-4-menus.netlify.com/userguide[User Guide] for the full version of my contribution.
|===
...
|===
|The following sections are portions of my contributions to the Developer Guide. They reflect my ability to convey
technical information in a comprehensible manner. It also showcases the technical depth of my contributions.
Since this is not the full version, some of the hyperlinks as seen under this section may not redirect as intended.
Please refer to section 4.4, 4.5, and UC50X of appendix C in the https://cs2103-ay1819s1-f10-4-menus.netlify.com/developerguide[Developer Guide]
for the full version of my contribution.
|===
